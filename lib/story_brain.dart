...
//if statements that map through story according to Destini-Story-Plan.pdf
  void nextStory(int userChoice) {
    if (userChoice == 1 && _storyNumber == 0) {
      ...
      //this would mesn you reached the end of the story therfore go back to beginning
      restart();
    }
  }
...
//returns bool on whether button should be visible according to the story plan
